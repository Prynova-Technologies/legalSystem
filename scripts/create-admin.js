...
var user_interface_1 = require("../src/interfaces/user.interface");
...
function createSuperAdmin() {
    return __awaiter(this, void 0, void 0, function () {
        var adminData, existingAdmin, admin, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, user_service_1.UserService.getUserByEmail(adminData.email)];
                case 1:
                    ...
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, user_service_1.UserService.createUser(adminData)];
                case 3:
                    admin = _a.sent();
